...
export default class comments_commenttypeListController extends controller {
    ...
    loadData = (SearchText, SearchFields,nextStartRow,sortField,onLoad) => {
            ...
            if (sortField === comments_commenttypeListController.SORTFIELD_ID)
            ...
            let url='/comments/commenttype'+filterString;
