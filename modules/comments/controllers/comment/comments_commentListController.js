...
export default class comments_commentListController extends controller {
    ...
    loadData = (SearchText, SearchFields,nextStartRow,sortField,onLoad) => {
            ...
            if (sortField === comments_commentListController.SORTFIELD_ID)
            ...
            let url='/comments/comment'+filterString;
