                ...
                <View style={{flex:1}}  >
                    ...
                    <ScrollView contentContainerStyle={{minHeight: this.height || heightOfDeviceScreen}}>
                            ...
                            <View flexDirection={'row'}>
                                <IconItem logo={require('../../values/files/images/icon/room.png')} title={'تعداد اتاق'} content={this.state.LoadedData.roomcountnum} style={{...IconStyle,backgroundColor:'rgba(168,236,131,0.15)',}}/>
                                ...
                                <IconItem logo={require('../../../../images/timeicon.png')} title={'حداکثر تعداد مهمان'} content={this.state.LoadedData.maxguestsnum}  style={{...IconStyle,backgroundColor:'rgba(168,236,131,0.25)',}}/>
                                    ...
                                    <View flexDirection={'row'}>
                                        <IconItem logo={require('../../values/files/images/icon/structurearea.png')} title={'متراژ بنا'} content={this.state.LoadedData.structureareanum} style={{...IconStyle,backgroundColor:'rgba(168,236,131,0.64)',}}/>
                                        <IconItem logo={require('../../values/files/images/icon/area.png')} title={'متراژ کل'} content={this.state.LoadedData.totalareanum} style={{...IconStyle,backgroundColor:'rgba(168,236,131,0.34)',}}/>
                                        <IconItem logo={require('../../values/files/images/icon/view.png')} title={'چشم انداز'} content={this.state.LoadedData.viewtypeinfo.name} style={{...IconStyle,backgroundColor:'rgba(168,236,131,0.25)',}}/>
                                    </View>
                                    <View flexDirection={'row'}>
                                        <IconItem logo={require('../../values/files/images/icon/structurearea.png')} title={'نوع ساختمان'} content={this.state.LoadedData.structuretypeinfo.name} style={{...IconStyle,backgroundColor:'rgba(168,236,131,0.50)',}}/>
                                        ...
                                        <IconItem logo={require('../../values/files/images/icon/view.png')} title={'ساعت تحویل'} content={this.state.LoadedData.timestartclk} style={{...IconStyle,backgroundColor:'rgba(168,236,131,0.75)',}}/>
                                    </View>
                                    <View flexDirection={'row'}>
                                        <IconItem logo={require('../../values/files/images/icon/structurearea.png')} title={'نوع اقامتگاه'} content={this.state.LoadedData.owningtypeinfo.name} style={{...IconStyle,backgroundColor:'rgba(168,236,131,0.88)',}}/>
                                        ...
                                        <IconItem logo={require('../../values/files/images/icon/view.png')} title={'قیمت عادی'} content={this.state.LoadedData.normalpriceprc} style={{...IconStyle,backgroundColor:'rgba(168,236,131,0.50)',}}/>
                                    </View>
                                    <View flexDirection={'row'}>
                                        <IconItem logo={require('../../values/files/images/icon/structurearea.png')} title={'قیمت در تعطیلات'} content={this.state.LoadedData.holidaypriceprc} style={{...IconStyle,backgroundColor:'rgba(168,236,131,0.64)',}}/>
                                        ...
                                        <IconItem logo={require('../../values/files/images/icon/view.png')} title={'تخفیف رزرو ماهانه'} content={this.state.LoadedData.monthlyoffnum} style={{...IconStyle,backgroundColor:'rgba(168,236,131,0.25)',}}/>
                                    </View>
