...
export default class carserviceorder_carListController extends controller {
    ...
    loadData = (SearchText, SearchFields,nextStartRow,sortField,onLoad) => {
            ...
            if (sortField === carserviceorder_carListController.SORTFIELD_ID)
            ...
            let url='/carserviceorder/car'+filterString;
